                ...
                {modalData && (
                    <div className="row">
                        ...
                        {[
                            ...
                            { label: 'รุ่นรถ:', value: modalData.Model },
                            { label: 'Part_No:', value: modalData.Part_No },
                            { label: 'พาร์ทลูกค้า:', value: modalData.OE_Part_No },
                            ...
                            { label: 'เบอร์กล่อง:', value: modalData.Box_No },
                            { label: 'น้ำหนักกล่อง:', value: modalData.Weight_Box },
                            { label: 'รหัสกล่อง_ERP:', value: modalData.Box_Erp_No },
                            { label: 'เบอร์รีเวท:', value: modalData.Rivet_No },
                            { label: 'น้ำหนักรีเวทต่อชุด:', value: modalData.Weight_Revit_Per_Set },
                            { label: 'จำนวนรีเวทต่อชุด:', value: modalData.Num_Revit_Per_Set },
                            { label: 'รหัสกรีเวท_ERP:', value: modalData.Revit_Erp_No },
