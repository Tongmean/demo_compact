...
import template from '../../Asset/Fg_template.xlsx';
...
const CreateFgExcel = () => {
    ...
    const handleSubmit = () => {
        ...
        axios.post(`${env.API_URL}/api/fg/createExcel`, excelData, {
            headers: {
                ...
                <div className='container-fluid'>
                    <div className='row pe-5'>
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p>Code_Fg, Name_Fg, Model, Part_No, พาร์ทลูกค้า, โค้ดการขาย, เกรดเคมี, ชิ้นต่อชุด, เบอร์กล่อง, น้ำหนักกล่อง, รหัสกล่อง_ERP, เบอร์รีเวท, นำหนักรีเวทต่อชุด, จำนวนรีเวทต่อชุด, รหัสรีเวท_ERP, หมายเหตุ</p>
                                <footer className="blockquote-footer">ต้องเรียงข้อมูลแต่ละ Column ตามนี้เท่านั้น</footer>
                                <footer className="blockquote-footer">Note: ถ้า Code_Fg มีอยู่ในฐานข้อมูลอยู่แล้า ไม่สามารถบันทึกซ้ำได้ ):</footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='row col-xl-4 col-lg-4 col-md-6'>
                            Excel Template
                            <div>
                                <a href={template} download="Fg_template.xlsx" className="btn btn-secondary ">Download Excel Template</a>
                            </div>
                        </div>
